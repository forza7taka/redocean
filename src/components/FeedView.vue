    ...
    <v-list-item v-for="(f, fIndex) in timeline.feed" :key="fIndex">
      ...
      <v-col class="d-flex justify-center align-center">
        ...
        <v-card-text class="text-pre-wrap">
          <div v-if="f && f.post && f.post.record && f.post.record.text" v-html="this.replaceUrls(f.post.record.text)"></div>
        </v-card-text>
        ...
        <v-btn class="ma-2" variant="text" icon="mdi-comment-outline" 
        @click="dialog = true;
        ...
        <div v-if="f.reply && f.reply.parent">
          ...
          <v-card width="350px" class="mx-auto mt-5">
            ...
            <v-card-text class="text-pre-wrap">
              <div v-if="f && f.reply && f.reply.parent && f.reply.parent.record && f.reply.parent.record.text" v-html="this.replaceUrls(f.reply.parent.record.text)"></div>
            </v-card-text>
            </v-card>
        </div>
      </v-card>
